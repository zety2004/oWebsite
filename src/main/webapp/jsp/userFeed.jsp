...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);" action="/homePage/queryFeedBack" method="post"
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="delete" href="/homePage/deleteFeedBackById?id={sid_user}" target="ajaxTodo"
    ...
    <table class="table" width="100%" layoutH="138">
        ...
        <tbody id="feedBack">
        <c:forEach items="${page.objList}" var="obj">
